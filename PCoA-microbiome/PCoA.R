...
data <- read.csv("otu_table.txt", head=TRUE,sep="\t",row.names = 1)
data <- data[,c(1,2,10,6,3,11,7,4,12,8,5,13,9)]
...
theme(panel.background = element_rect(fill='white', colour='black'),
      ...
      legend.key=element_blank(),legend.position = c(0.07,0.74),
...
sample1 <- c("C0","","","HP7","C15","","HP15","C25","LP25","HP25","C40","LP40","HP40")
sample2 <- c("","C7","LP7","","","LP15",rep("",7))
